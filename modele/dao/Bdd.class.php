...
class Bdd {
    ...
    private static $login = "mgarnier";   // login utilisateur de la BDD      mgarnier
    private static $mdp = "HhY+8wN@4M";         // mdp  utilisateur de la BDD       HhY+8wN@4M
    private static $bd = "mgarnier_resto2";          // nom de la BDD                    mgarnier_resto2
